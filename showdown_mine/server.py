...
def generate_ws_url(server_hostname):
    ...
    """
    return "ws://raw-showdown-test.herokuapp.com/showdown/{num_triplet}/{char_octet}/websocket".format(
...
def generate_action_url(server_id):
    ...
    """
#    return "https://play.pokemonshowdown.com/action.php"
    return "https://play.pokemonshowdown.com/~~raw-showdown-test.herokuapp.com.psim.us/action.php"
    return "http://raw-showdown-test.herokuapp.com/action.php"
